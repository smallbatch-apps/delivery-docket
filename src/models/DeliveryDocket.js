...
const LotSchema = new Schema ({
  ...
  teSealInPlace: { type: Boolean, required: false },
...
const DeclarationSchema = new Schema({
  ...
  otcTreatmentBlanketFed: {type: Boolean, required: true, default: false},
  otcTreatmentSpotFed: {type: Boolean, required: true, default: false},
  otcTreatmentPercentage: {type: Number, required: false},
...
const DeliveryDocketSchema = new Schema({
  ...
  lodgementDate: {type: Date, required: true },
